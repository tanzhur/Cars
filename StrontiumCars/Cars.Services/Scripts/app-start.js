...
(function () {
    ...
    router.route("/add", function () {
        ...
        viewsFactory.getAddCarView().then(function (addCarHTML) {
            var viewModel = viewModelFactory.getAddCarViewModel();
    ...
    router.route("/my-cars", function () {
        loginPageCheck();
        clearMainContainer();
        $('#main-content').load('../Scripts/Views/my-cars.html', function () {
        });
    });
    ...
    function handleMenuTemplate() {
        ...
        //    menuContent.remove(item.children("li").eq(0));
        //}
    ...
    function attachEvents(selector) {
        selector.on('click', '#getLoginForm', function (ev) {
            ev.preventDefault();
            //$('#register-login').load('../Scripts/Views/login.html', function () {
            //});
            viewsFactory.getLoginView().then(function (loginFormHTML) {
                var viewModel = viewModelFactory.getLoginViewModel();
                var view = new kendo.View(loginFormHTML, { model: viewModel });
                layout.showIn("#register-login", view);
            });
        });
        ...
        selector.on('click', '#getRegisterForm', function (ev) {
            ...
            //$('#register-login').load('../Scripts/Views/register.html', function () {
            //});
            viewsFactory.getRegisterView().then(function (registerFormHTML) {
                var viewModel = viewModelFactory.getRegisterViewModel(function () { router.navigate('/'); });
